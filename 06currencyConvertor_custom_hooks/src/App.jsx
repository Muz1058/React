...
function App() {
  ...
  return (
    <div
      className="m-0 p-0 w-full h-screen flex flex-wrap justify-center items-center bg-cover bg-no-repeat"
      style={{
        ...
        <div className="w-full max-w-md mx-auto border border-gray-60 rounded-lg p-5 backdrop-blur-sm bg-white/30">
          ...
          >
            ...
            <div className="relative w-full h-0.5">
              <button
                type="button"
                className="absolute left-1/2 -translate-x-1/2 -translate-y-1/2 border-2 border-white rounded-md bg-blue-400 text-black px-2 py-0.5"
                onClick={swap}
              >
                Swap
              </button>
